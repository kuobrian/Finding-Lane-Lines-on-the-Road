...
class LaneFilter:
	...
	def apply_color_mask(self):
		...
		color_mask = self.z.copy()
		color_mask[(self.color_cond1 | self.color_cond2)] = 1
		return color_mask
	...
	def apply_sobel_mask(self):
		...
		sobel_mask[(self.sobel_cond1 & self.sobel_cond2 & self.sobel_cond3)] = 1
		return sobel_mask
